...
KEY_BINDS = {
  ...
  ******************************************/
  playChaserRevealFanfare: {
    keys: [ "q" ],
    description: "Plays the Chaser reveal fanfare. ",
    action: () => sfx_playSFX( chaserEnter )
  },
  playChaseBeginFanfare: {
    keys: [ "w" ],
    description: "Plays 'The Chase is On' fanfare. ",
    action: () => sfx_playSFX( chaseBegin )
  },
  playPlayerCaughtFanfare: {
    keys: [ "e" ],
    description: "Plays fanfare for when the player is caught and walks off. ",
    action: () => sfx_playSFX( caughtExit )
  },
  toggleMusic: {
    keys: [ "n" ],
